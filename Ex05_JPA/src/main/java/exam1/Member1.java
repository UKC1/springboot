...
public class Member1 {
	 ...
	 * - insertable : insert를 할 때 이 컬럼을 포함할 것인지 결정(기본값 true)
	 * - length : 문자열 타입의 컬럼의 길이 지정(기본값:255)
	 * - columnDefinition : 컬럼에 대한 ddl문을 직접 기술할 수 있음 ex) @@Column(columnDefinition="verchar2(200)" default ''
	 * 
	 */
	
	@Column(name="create_date")
	private LocalDate createDate; // 과거에는 Date
	/*
	 * LocalDateTime
